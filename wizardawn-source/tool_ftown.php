...
if ($menu_section == 3)
{
	...
	?>
		...
		<p style='text-align: justify;'>Races: Selecting &quot;all&quot; or &quot;none&quot; below will use all the races available...otherwise...check the boxes if you only want a few races living in the settlement.<br>

		<div id="div_tabex">
			<div class="row" style="font-size: 12px;">
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_human" value="1">Human</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_brownie" value="1">Brownie</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_centaur" value="1">Centaur</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_cyclops" value="1">Cyclops</span>
			</div>
			<div class="row" style="font-size: 12px;">
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_daklafar" value="1">Daklafar (Dark Elf)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_dwarf" value="1">Dwarf</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_dwurman" value="1">Dwurman (Dark Dwarf)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_elf" value="1">Elf</span>
			</div>
			<div class="row" style="font-size: 12px;">
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_fairy" value="1">Fairy</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_falcoran" value="1">Falcoran (Bird Man)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_fruglum" value="1">Fruglum (Frog Man)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_gnome" value="1">Gnome</span>
			</div>
			<div class="row" style="font-size: 12px;">
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_goblin" value="1">Goblin</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_gremlin" value="1">Gremlin</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_greyling" value="1">Greyling (Gray Brownie)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_hobgoblin" value="1">Hobgoblin</span>
			</div>
			<div class="row" style="font-size: 12px;">
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_hobling" value="1">Hobbit</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_imp" value="1">Imp</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_kobold" value="1">Kobold</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_leprechaun" value="1">Leprechaun</span>
			</div>
			<div class="row" style="font-size: 12px;">
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_mantaran" value="1">Mantaran (Insect Man)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_minotaur" value="1">Minotaur</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_neptar" value="1">Neptar (Fish Man)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_ogre" value="1">Ogre</span>
			</div>
			<div class="row" style="font-size: 12px;">
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_orke" value="1">Orc</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_pixie" value="1">Pixie</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_rattanu" value="1">Rattanu (Rat Man)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_satyr" value="1">Satyr</span>
			</div>
			<div class="row" style="font-size: 12px;">
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_sauriman" value="1">Sauriman (Lizard Man)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_slitheran" value="1">Slitheran (Snake Man)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_sprite" value="1">Sprite</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_suvart" value="1">Suvart (Deep Gnome)</span>
			</div>
			<div class="row" style="font-size: 12px;">
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_tigran" value="1">Tigran (Cat Man)</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_troll" value="1">Troll</span>
				<span class="cell"><input type="checkbox" id="InputOption" name="x_race_wulfan" value="1">Wulfan (Wolf Man)</span>
				<span class="cell">&nbsp;</span>
			</div>
		</div>
		<br>
		...
		<div id="div_table">
			...
			<div class="row">
				<span class="cell"><?php $lnum = $lnum + 1; echo $lnum; ?>.</span>
				<span class="cxll">Lastly, select the races that live in this settlement. By default, all races shown here will live in harmony.</span>
			</div>
		</div>
...
$shoptq = "CREATE TEMPORARY TABLE shop_track (building INT(20) NOT NULL, owner VARCHAR(250) NOT NULL, shop INT(2) NOT NULL, type VARCHAR(100) NOT NULL, info LONGTEXT NOT NULL, stats LONGTEXT NOT NULL, gender VARCHAR(10) NOT NULL, didit INT(1) NOT NULL, race VARCHAR(100) NOT NULL)";
...
if ($rulers > 0){ echo "<br><div style='page-break-after: always; height:1px;'>&nbsp;</div>";
	...
	if (mt_rand(1,4) > 1)
	{
		...
		$remp_gender = "Male";
		echo "<font size='2'><b>" . strtoupper($royal_title) . ":</b> <i>[Level " . GameLvlChar($game,4) . " Warrior]</i> "; 
		$equipment = GFTequipCitizen(warrior);
		$weaponsize = "medium";
		$remp_kindred = GFTRace($x_races);
		$remp_citizen = GFTCitizen($remp_kindred,adult,$remp_gender);
		echo $remp_citizen[2] . " <b>ARMS&nbsp;&amp;&nbsp;ARMOR:</b> " . strtolower(getWeapon($weaponsize)) . ", " . $equipment[0] . ", " . $equipment[1] . "</font>";
			...
			echo "<hr color='#C0C0C0' size='1'><font size='2'><b>" . strtoupper($royal_title) . ":</b> <i>[Level " . GameLvlChar($game,3) . " " . ucfirst($royal_class) . "]</i> "; 
			$equipment = GFTequipCitizen($royal_class);
			$weaponsize = "small";
			$remp_kindred = GFTRace($x_races);
			$remp_citizen = GFTCitizen($remp_citizen[1],adult,$remp_gender);
			echo $remp_citizen[2] . " <b>ARMS&nbsp;&amp;&nbsp;ARMOR:</b> " . strtolower(getWeapon($weaponsize)) . ", " . $equipment[0] . ", " . $equipment[1] . "</font>";
	}
	else
	{
		...
		{
			echo "<hr color='#C0C0C0' size='1'><font size='2'><b>ROYAL WIZARD:</b>  <i>[Level " . GameLvlChar($game,4) . " Wizard]</i> "; 
			$equipment = GFTequipCitizen(wizard);
			$weaponsize = "small";
			$remp_kindred = GFTRace($x_races);
		...
		{
			echo "<hr color='#C0C0C0' size='1'><font size='2'><b>ROYAL SPY:</b>  <i>[Level " . GameLvlChar($game,4) . " Rogue]</i> "; 
			$equipment = GFTequipCitizen(rogue);
			$weaponsize = "medium";
			$remp_kindred = GFTRace($x_races);
			$remp_gender = "Male"; if (mt_rand(1,2) == 1){$remp_gender = "Female";}
			$remp_citizen = GFTCitizen($remp_kindred,adult,$remp_gender);
		...
		if ($realm >= mt_rand(1,5))
		{
			...
			echo "<hr color='#C0C0C0' size='1'><font size='2'><b>" . $royal_title . ":</b>  <i>[Level " . GameLvlChar($game,3) . " Warrior]</i> "; 
			$equipment = GFTequipCitizen(warrior);
			$weaponsize = "giant";
			$remp_kindred = GFTRace($x_races);
			$remp_gender = "Male"; if (mt_rand(1,2) == 1){$remp_gender = "Female";}
		...
		if ($police > 0)
		{
			while ($royal_guards > 0) :
				echo "<hr color='#C0C0C0' size='1'><font size='2'><b>ROYAL GUARD:</b>  <i>[Level " . GameLvlChar($game,1) . " Warrior]</i> "; 
				$equipment = GFTequipCitizen(warrior);
				$weaponsize = "giant";
				$remp_kindred = GFTRace($x_races);
				$remp_gender = "Male"; if (mt_rand(1,2) == 1){$remp_gender = "Female";}
...
{ 
	while ($key > 0) : $city_size = $city_size + 1;
		$kindred = GFTRace($x_races);
		$gender = "Male"; if (mt_rand(1,2) == 1){$gender = "Female";}
		$citizen = GFTCitizen($kindred,adult,$gender);
		$dwell = $dwell + 1;
...
else
{
	...
	else
	{
		...
		if (mt_rand(1,100) > 50){ if ($citizen[0] == "Male"){$gend = "Female";} else {$gend = "Male";}     $citizen = GFTCitizen($citizen[1],adult,$gend); ?>
			<hr color='#C0C0C0' size='1'><font size="2">&nbsp;-&nbsp;-&nbsp;<?php echo $citizen[2]; ?></font><?php } 

		if (mt_rand(1,100) > 70){ $gend = "Male"; if (mt_rand(1,2) == 1){$gend = "Female";} $citizen = GFTCitizen($citizen[1],child,$gend); ?>
			<hr color='#C0C0C0' size='1'><font size="2">&nbsp;-&nbsp;-&nbsp;-&nbsp;<?php echo $citizen[2]; ?></font><?php } 

		if (mt_rand(1,100) > 90){ $gend = "Male"; if (mt_rand(1,2) == 1){$gend = "Female";} $citizen = GFTCitizen($citizen[1],child,$gend); ?>
			<hr color='#C0C0C0' size='1'><font size="2">&nbsp;-&nbsp;-&nbsp;-&nbsp;<?php echo $citizen[2]; ?></font><?php } 
	}
	$key = $key - 1; endwhile;
}
...
if ($stores > 0) ////////////////// STORES ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	if ($shckkn > 0)
	{
		...
		<?php $doneit = 1;
		include("functions/fantasy_stores_gn.php");
	} 
} /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if ($guilds > 0) ////////////////// GUILDS ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	if ($shckkn > 0)
	{
		...
		<?php $doneit = 2; include("functions/fantasy_stores_gn.php");
	}
} /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if ($police > 0) ////////////////// GUARDS ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	if ($shckkn > 0)
	{
		...
		<?php $doneit = 3; include("functions/fantasy_stores_gn.php");
	}
} /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if ($church > 0) ////////////////// CHURCH ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	if ($shckkn > 0)
	{
		...
		<?php $doneit = 4; include("functions/fantasy_stores_gn.php");
	}
}
